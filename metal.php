    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-black" data-aos="fade-up" data-aos-duration="800" >
                <h1 class="fw-bold h2 mb-5">Trade Precious and Industrial Metals</h1>
        ...
        <div class="row" >
            <div class="col-md-6 text-center" >
                ...
                <div class="position-relative set-diamond-image" >
                    <img src="<?php echo getBaseUrl(); ?>/assets/images/diamonds/silver-diamond.png" alt="Corner Image" class="position-absolute bottom-0 start-0 float-y" style="width: 100px; height: 60px; margin: -60px -15px;">
                </div>
            </div>
            <div class="col-md-6">
                <p class="mb-0 small">
...
<div class="container py-5">
    ...
    <div class="text-center mb-4">
        <h2 class="h2" data-aos="fade-up" data-aos-duration="800" >
            Institutional Market Feed - Metal CFDs
        </h2>
    ...
    <div class="row g-4 justify-content-center mt-5">
        ...
        <div class="col-12 col-sm-3 col-md-3 col-xxl" data-aos="fade-up" data-aos-duration="400" >
            <div class="position-relative">
                <img src="<?php echo getBaseUrl(); ?>/assets/images/metal-alluminum.png" alt="Corner Image" class="position-absolute" style="width: 90%; margin: -85px 15px;" data-aos="fade-up" data-aos-duration="1000" >
            </div>
            ...
            <div class="stock-card">
                ...
                <div class="">
                    ...
                    <div class="d-md-flex justify-content-around px-3 mb-3">
                        <button class="btn btn-buy openLiveAccount">Buy</button>
                        <button class="btn btn-sell openLiveAccount">Sell</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="card tech-feature p-4">
                    <div class="d-flex gap-3 align-items-start">
                        <div class="icon-circle mt-2">
                            <img src="<?php echo getBaseUrl(); ?>/assets/images/svg/inflation.svg" alt="Inflation Hedge">
                        </div>
                        <div>
...
$featureIconArr = [
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Safe-haven-assets.png',
        'title' => 'Safe-haven assets'
    ],
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Hedge-against-inflation.png',
        'title' => 'Hedge against inflation'
    ],
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/High-global-demand.png',
    ...
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Store-of-long-term-value.png',
        'title' => 'Store of long-term value'
    ],
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Leverage-opportunities.png',
        'title' => 'Leverage opportunities'
    ],
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Crisis-and-recession-protection.png',
        'title' => 'Crisis and recession protection'
    ],
    [
        'icon' => getBaseUrl().'/assets/images/flat-icon/Benchmark-commodities.png',
