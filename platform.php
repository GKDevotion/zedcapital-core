    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                ...
                <div class="position-relative set-diamond-image">
                    <img src="<?php echo getBaseUrl(); ?>/assets/images/diamonds/silver-diamond.png" alt="Corner Image" class="position-absolute start-0 bottom-0 float-y" style="width: 80px; height: 50px; margin: -140px -50px;">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 mb-3" data-aos="fade-up" data-aos-duration="800">
                <div class="row m-0 gray-border">
                    ...
                    <div class="col-12 col-sm-8 pb-3 px-0" style="margin-top: -18px;">
                        ...
                        <ul class="platform-arrow-list m-0 feature-list-extra pe-0 pe-md-4">
                            <li class="px-4 pb-2">
                                <b>No Installation Needed: </b>Access instantly from any modern browser.
                            </li>
                            <li class="px-4 pb-2">
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 p-4 px-2">
        <div class="bg-white rounded-4 shadow-sm m-1 m-md-5 p-2 p-md-5 card-scene">
