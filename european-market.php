...
<div class="container py-4">
    ...
    <div class="market-tab d-flex justify-content-between align-items-center bg-black text-white rounded-pill px-3 flex-wrap">
        ...
        <div class="text-center flex-fill py-2 d-none d-md-block">
            <a class="text-red text-decoration-none" href="<?php echo getBaseUrl(); ?>/european-market">
                Europian Market
            </a>
        </div>
        <div class="text-center flex-fill py-2 d-none d-md-block">
            <a class="text-white text-decoration-none" href="<?php echo getBaseUrl(); ?>/middle-eastern-market">
                Middle East Market
            </a>
        </div>
        <div class="text-center flex-fill py-2 d-none d-md-block">
...
<div class="container py-5">
    <div class="row">
        <!-- Left Column -->
        <div class="col-lg-8 mb-4 europen-market-matters">
        ...
        <div class="col-12 europen-market-matters mt-4">
            <p class="text-muted text-gray">
