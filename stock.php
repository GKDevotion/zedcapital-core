...
<div class="container py-5 mb-5">
    ...
    <div class="text-center mb-4" >
        <h2 class="h2" data-aos="fade-up" data-aos-duration="850">
            Institutional Market Feed - Stock CFDs
        </h2>
...
<script>
    ...
    const symbols = ["NVIDIA", "Tesla", "Facebook", "Apple", "Intel", "Amazon", "Oracle", "Microsoft", "Coinbase", "Alphabet", "Netflix"];
                ...
                <div class="card tech-feature p-4">
                    <div class="d-flex gap-3 align-items-start">
                        <div class="icon-circle mt-2">
                            <img src="<?php echo getBaseUrl(); ?>/assets/images/svg/Diversification.svg" alt="Diversified Access">
                        </div>
                        <div>
