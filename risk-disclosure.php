...
<style>
  ...
  <main class="container py-5">
    ...
    <div class="policy-section" data-aos="fade-up" data-aos-delay="300">
      ...
      <ul class="list-style">
        <li>the failure of the Customer's hardware, software and internet connection;</li>
        <li>the improper operation of the Customer's equipment;</li>
        <li>the wrong settings in the Client Terminal;</li>
        <li>delayed Client Terminal updates; and</li>
        <li>the Customer’s ignorance of the applicable rules described in the user guide for the Client Terminal and in the help section.</li>
      </ul>
    ...
    <div class="policy-section" data-aos="fade-up" data-aos-delay="400">
      ...
      <p>
        The Customer must be aware of commissions and other charges before trading. Charges may be expressed in monetary terms, percentage terms or in other unit of measurement and it is therefore the responsibility of the Customer to understand what such charges amount to.
      </p>
    </div>
  </main>
