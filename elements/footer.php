        ...
        <style>
            ...
            .footer-meta a:hover, .footer-links a:hover {
                text-decoration: none;
                /* font-weight: 600; */
                        ...
                        <div class="text-center col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="socil-media-icon">
                                <ul class="mb-0 p-0">
                                    ...
                                    <li>
                                        <a target="_blank" href="https://www.instagram.com/zedcapitalofficial" class="instagram" title="Instagram">
                                            <i class="fab fa-instagram icon"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://www.linkedin.com/company/zed-capital-international-limited" class="linkedin" title="Linked In">
                                            <i class="fab fa-linkedin icon"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://x.com/zed_capital?t=JtBoE2-UcJYti_RHhffeDA&amp;s=09" class="twitter" title="Twitter">
        ...
        <script>
            ...
            function buildTooltipContent(market) {
                ...
                const localTime = new Date(nowUTC.toLocaleString('en-US', { timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone }));
                const localTimeStr = localTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
            ...
            function initMap() {
                ...
                styles: [
                    ...
                    { featureType: "administrative.country", elementType: "geometry.stroke", stylers: [{ color: "#f1eeee" }, { weight: 1.5 }] },
