                ...
                <div class="accordion" id="amfaqAccordion">
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq1" aria-expanded="false" aria-controls="amfaq1">
                                1. What makes the American financial market the center of global finance?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq2" aria-expanded="true" aria-controls="amfaq2">
                                2. What are the main components of the U.S. financial market?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq3" aria-expanded="false" aria-controls="amfaq3">
                                3. Why do global investors prefer U.S. equities?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq4" aria-expanded="false" aria-controls="amfaq4">
                                4. How does the U.S. bond market influence global finance?
                            </button>
                        </h2>
                        <div id="amfaq4" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                The U.S. Treasury market sets the global benchmark for “risk-free” interest rates, impacting everything from mortgages to international reserves. Corporate and municipal bonds add depth, providing income-generating and tax-efficient investment options.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingFive">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq5" aria-expanded="false" aria-controls="amfaq5">
                                5. Why is the U.S. dollar considered the world’s reserve currency?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingSix">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq1" aria-expanded="false" aria-controls="amfaq1">
                                6. What role do commodities and derivatives play in the American market?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingSeven">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq2" aria-expanded="true" aria-controls="amfaq2">
                                7. What opportunities does the American market offer investors?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingEight">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq3" aria-expanded="false" aria-controls="amfaq3">
                                8. What are the key risks of investing in the American market?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingNine">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq4" aria-expanded="false" aria-controls="amfaq4">
                                9. How does Zed Capital International Ltd help clients navigate the U.S. market?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item" data-aos="fade-up" data-aos-duration="850">
                        <h2 class="accordion-header" id="headingTen">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#amfaq10" aria-expanded="false" aria-controls="amfaq10">
                                10. What is the long-term outlook for the American market?
                            </button>
                        </h2>
